...
def get_args():
    ...
    # dataset
    parser.add_argument('--severity', default=5, type=int, help='level of severity')
    parser.add_argument('--corruption', default='gaussian_noise', type=str, help='corruption type  (default:gaussian_noise)')
    ...
    # Exp Settings
    parser.add_argument('--method', default='deyo', type=str, help='no_adapt, tent, deyo')
    parser.add_argument('--model', default='resnet50', type=str, help='resnet50 or kan or ')
