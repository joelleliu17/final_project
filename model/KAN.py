...
class KAN_Convolution(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        self.device = x.device
        return multiple_convs_kan_conv2d(x, self.conv,self.kernel_size[0],self.stride,self.dilation,self.padding,self.device)
